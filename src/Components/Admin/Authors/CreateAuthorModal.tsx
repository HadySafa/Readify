...
type CreateAuthorModalProps = {
    setShowCreateAuthorForm: React.Dispatch<React.SetStateAction<boolean>>;
};


export default function CreateAuthorModal({ setShowCreateAuthorForm }: CreateAuthorModalProps) {
    ...
    const [formData, setFormData] = useState<{ name: string, bio: string }>({ name: "", bio: ""});
    ...
    async function handleConfirm() {
        ...
        try {
            ...
            addNotification("Author added successfully.", "success")
        }
        catch (error: unknown) {
                ...
                <div className="w-full max-w-2xl p-6 bg-white shadow-md rounded-2xl">
                    ...
                    <div className="pb-2 text-center border-b border-gray-200">
                        <div className="flex items-center justify-center gap-3 mb-4">
                            ...
                            <h1 className="text-2xl font-bold text-green-900">Create Author</h1>
                        </div>
                    </div>
